    ...
    $result['allbooking'] = array();
        ...
        if(count($db) > 0) {
            ...
            if($shop_ID!=0){
                ...
                if(count($db2)>0){
                    foreach($db2 as $db2s){
                    $index['shop_Name'] = $db2s['shop_Name']; 
                    $index['shop_Address'] = $db2s['shop_Address']; 
                    $index['shop_ContactNo1'] = $db2s['shop_ContactNo1']; 
                    $index['handwasher_LName'] = ""; 
                    $index['handwasher_Address'] = ""; 
                    $index['handwasher_Contact'] = "";
                    }
                }
