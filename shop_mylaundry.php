<?php
	...
	if ($_SERVER['REQUEST_METHOD']=='POST') 
	{
        ...
        $db = DB::transact_db("SELECT CONCAT(c.client_FName, ' ', c.client_MidName, ' ', c.client_LName) AS client_Name, c.client_ID, c.client_Address, c.client_Contact, c.client_Photo, t.* from laundry_client c, laundry_transaction t where t.client_ID = c.client_ID AND t.trans_Status = 'Confirmed' AND t.lsp_ID = ?",
								array($shopID),
								"SELECT"
                            );
